...
/// This event indexer trait would be shared across all supported chains
#[async_trait]
pub trait ChronicleEventIndexer {
    ...
    async fn query_events(
        ...
        block_number: Self::BlockNumber, // Fixed typo: block_nuber -> block_number
        db_manager: &DatabaseManager, // Changed from &mut Client to &DatabaseManager
    ) -> Result<(), anyhow::Error>;
